...
import 'package:hausify_v2/features/shop/controllers/banner_controller.dart';
...
class HPromoSlider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    /// Changing Promos from HomeController to BannerController
